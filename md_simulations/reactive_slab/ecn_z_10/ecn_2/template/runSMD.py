...
restart = True
nstep = int(6000000) # in total 3000 ps, pull from -3.0 to 3.0, pulling speed is 2 A/ns, fixed depth and CN
...
c: COM ATOMS=12-5011 NOPBC # COM of all 1000 water molecules
...
PRINT ARG=HtoC,HtoO,diff,restraint.diff_cntr,depth.z,cn,restraint.diff_work STRIDE=10 FILE=SMD.cv
FLUSH STRIDE=1000
"""
