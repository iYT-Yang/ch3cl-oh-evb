...
restart = False
nstep = int(10000000) # in total 5000 ps (0.5 ns eqm at desired depth and weak restrain at CV=-3.0, 0.5 ns eqm at CV=-3.0 with kappa changing from 500 to 10000, 2 ns eqm at CV=-3.0 with kappa=10000, 2 ns then to collect rst files into config_bank, every 10 ps one config, in total 200 configs) 
...
restraintdepth: RESTRAINT ARG=depth.z AT=59.52  KAPPA=100
...
PRINT ARG=HtoC,HtoO,diff,restraint.diff_cntr,depth.z,restraint.diff_work STRIDE=20000 FILE=SMD.cv
FLUSH STRIDE=20000
"""
