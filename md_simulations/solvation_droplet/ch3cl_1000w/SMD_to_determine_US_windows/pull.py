...
#nsteps=int(15*2e06) #15 ns -> pull 30 A
nsteps=int(20*2e06) #20 ns -> pull 40 A (1000w)
nsavcrd=200000 ###save frequency for .dcd
nprint=200000 ###save frequency for .log
...
for i in range(wall.getNumGroups()):
    wall.addBond([i],[2000.0*kilojoules_per_mole/(nanometer)**2, 6.0*nanometer]) # 6.0 nm for 1000w
wall.setUsesPeriodicBoundaryConditions(False)
system.addForce(wall)

## pulling at 0.2 nm/ns
...
restraint: MOVINGRESTRAINT ...
    ARG=dist.z
    STEP0=0 AT0=40.0 KAPPA0=100.0
    STEP1=40000000 AT1=0.0 KAPPA1=100.0
...
...
PRINT ARG=dist.z,restraint.dist.z_cntr,restraint.dist.z_work STRIDE=200000 FILE=pull.cv
"""
...
###restart from .rst
print('#Startting from ','eqm.rst')
simulation.loadState('eqm.rst')
...
###create final restart file
state = simulation.context.getState(getPositions=True,getVelocities=True,getEnergy=True)
with open('%s.rst'%(jobname), 'w') as f:
