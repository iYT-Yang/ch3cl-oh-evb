...
steps=int(80*2e06) # 80 ns (this nvt2.py only did the production run)

nsavcrd=2000000 ###save frequency for .dcd
nprint=2000000 ###save frequency for .log
...
PRINT ARG=dist.z,restraint.bias STRIDE=2000 FILE=CV/%d.cv
